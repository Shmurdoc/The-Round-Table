                ...
                <div class="relative hidden lg:block">
                    ...
                    <div class="relative z-20">
                        <div class="cyber-border rounded-3xl overflow-hidden image-card">
                            <img src="{{ Storage::url('cohorts/images/inv5.jpg') }}" alt="Investment Partnership" class="w-full h-80 object-cover">
                    ...
                    <div class="absolute -top-8 -right-8 z-30 image-card">
                        <div class="w-40 h-40 rounded-2xl overflow-hidden border-2 border-slate-700 shadow-2xl">
                            <img src="{{ Storage::url('cohorts/images/videoframe_14198.png') }}" alt="Tech Investment" class="w-full h-full object-cover">
                    ...
                    <div class="absolute -bottom-4 -left-8 z-10 image-card">
                        <div class="w-48 h-32 rounded-2xl overflow-hidden border-2 border-slate-700 shadow-2xl">
                            <img src="{{ Storage::url('cohorts/images/inv7.jpg') }}" alt="Business Partnership" class="w-full h-full object-cover">
            ...
            <div class="grid md:grid-cols-3 gap-8">
                ...
                <div class="bg-slate-800/30 backdrop-blur border border-slate-700/50 p-8 rounded-3xl relative group hover:border-amber-500/30 transition-all image-card overflow-hidden">
                    <div class="absolute inset-0 opacity-20">
                        <img src="{{ Storage::url('cohorts/images/videoframe_28362.png') }}" alt="" class="w-full h-full object-cover">
                ...
                <div class="bg-slate-800/30 backdrop-blur border border-slate-700/50 p-8 rounded-3xl relative group hover:border-amber-500/30 transition-all image-card overflow-hidden">
                    <div class="absolute inset-0 opacity-20">
                        <img src="{{ Storage::url('cohorts/images/videoframe_4633.png') }}" alt="" class="w-full h-full object-cover">
                        <div class="absolute inset-0 bg-gradient-to-t from-slate-900 via-slate-900/80 to-slate-900/60"></div>
                    </div>
                    <div class="relative z-10">
                ...
                <div class="bg-slate-800/30 backdrop-blur border border-slate-700/50 p-8 rounded-3xl relative group hover:border-amber-500/30 transition-all image-card overflow-hidden">
                    <div class="absolute inset-0 opacity-20">
                        <img src="{{ Storage::url('cohorts/images/videoframe_6207.png') }}" alt="" class="w-full h-full object-cover">
                        <div class="absolute inset-0 bg-gradient-to-t from-slate-900 via-slate-900/80 to-slate-900/60"></div>
                    </div>
                    <div class="relative z-10">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <div class="col-span-2 row-span-2 image-card group">
                    <div class="relative h-full min-h-[400px] rounded-3xl overflow-hidden cyber-border">
                        <img src="{{ Storage::url('cohorts/images/1d1c59e10dc609feb4988bd1245d765e.jpg') }}" alt="Premium Investment" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700">
                ...
                <div class="image-card group">
                    <div class="relative h-48 rounded-2xl overflow-hidden">
                        <img src="{{ Storage::url('cohorts/images/6371eb0e5abb1bf3b103a54f488be0df.jpg') }}" alt="Tech Investment" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700">
                        <div class="absolute inset-0 bg-gradient-to-t from-slate-950 via-transparent to-transparent"></div>
                ...
                <div class="image-card group">
                    <div class="relative h-48 rounded-2xl overflow-hidden">
                        <img src="{{ Storage::url('cohorts/images/inv7.jpg') }}" alt="Business Partnership" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700">
                        <div class="absolute inset-0 bg-gradient-to-t from-slate-950 via-transparent to-transparent"></div>
                        <div class="absolute bottom-4 left-4 right-4">
                ...
                <div class="image-card group">
                    <div class="relative h-48 rounded-2xl overflow-hidden">
                        <img src="{{ Storage::url('cohorts/images/videoframe_14198.png') }}" alt="Energy Project" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700">
                        <div class="absolute inset-0 bg-gradient-to-t from-slate-950 via-transparent to-transparent"></div>
                        <div class="absolute bottom-4 left-4 right-4">
                ...
                <div class="image-card group">
                    <div class="relative h-48 rounded-2xl overflow-hidden">
                        <img src="{{ Storage::url('cohorts/images/inv5.jpg') }}" alt="Property Fund" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700">
                        <div class="absolute inset-0 bg-gradient-to-t from-slate-950 via-transparent to-transparent"></div>
                        <div class="absolute bottom-4 left-4 right-4">
