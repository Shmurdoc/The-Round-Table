...
<?php $__env->startSection('title', $cohort->title . ' - RoundTable'); ?>
...
<div class="slide-up space-y-8">
    ...
    <div class="flex items-center justify-between">
        <a href="<?php echo e(route('cohorts.index')); ?>" class="flex items-center space-x-2 text-slate-500 hover:text-slate-700 transition-colors">
    ...
    <div class="space-y-6">
            ...
            <div class="absolute bottom-0 left-0 right-0 p-8 text-white z-10">
                <div class="flex flex-wrap gap-3 mb-4">
                    <span class="px-3 py-1 bg-white/20 backdrop-blur-md border border-white/30 text-white text-xs font-bold rounded-md uppercase tracking-wider flex items-center">
                        ...
                        <?php echo e(ucfirst($cohort->cohort_class ?? 'Standard')); ?>
                    ...
                    ?>
                    <span class="px-3 py-1 <?php echo e($riskColor); ?> backdrop-blur-md text-xs font-bold rounded-md uppercase tracking-wider">
                        <?php echo e(ucfirst($cohort->risk_level ?? 'Moderate')); ?> Risk
                    </span>
                </div>
                
                <h1 class="text-3xl md:text-4xl font-extrabold mb-3 drop-shadow-lg">
                    <?php echo e($cohort->title); ?>

                </h1>
                
                <p class="text-white/90 text-lg leading-relaxed max-w-3xl drop-shadow">
                    <?php echo e(Str::limit($cohort->description, 200)); ?>
        ...
        <div class="flex flex-wrap gap-3">
            ...
            ?>
            <span class="px-3 py-1 <?php echo e($riskColor); ?> text-xs font-bold rounded-md uppercase tracking-wider">
                <?php echo e(ucfirst($cohort->risk_level ?? 'Moderate')); ?> Risk
            </span>
        </div>
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4 py-6 border-y border-slate-100">
            <div class="flex items-center space-x-3">
                ...
                <div>
                    ...
                    <div class="text-slate-900 font-bold text-sm leading-tight"><?php echo e($cohort->asset_type ?? 'Real Estate'); ?></div>
                </div>
            </div>
            <div class="flex items-center space-x-3">
                <div class="bg-slate-100 p-2.5 rounded-lg">
                ...
                <div>
                    ...
                    <div class="text-slate-900 font-bold text-sm leading-tight">R<?php echo e(number_format($cohort->min_contribution / 100, 0)); ?></div>
                </div>
            </div>
            <div class="flex items-center space-x-3">
                <div class="bg-slate-100 p-2.5 rounded-lg">
                ...
                <div>
                    ...
                    <div class="text-emerald-600 font-bold text-sm leading-tight"><?php echo e($cohort->projected_annual_return ?? '12-18'); ?>%</div>
                </div>
            </div>
            <div class="flex items-center space-x-3">
                <div class="bg-slate-100 p-2.5 rounded-lg">
                ...
                <div>
                    ...
                    <div class="text-slate-900 font-bold text-sm leading-tight"><?php echo e($cohort->member_count ?? 0); ?>/50</div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="bg-slate-900 rounded-3xl p-8 text-white relative overflow-hidden shadow-2xl">
        ...
        <div class="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-end mb-6 gap-4">
            <div>
                <div class="text-4xl font-mono font-bold tracking-tighter">R<?php echo e(number_format($cohort->current_capital / 100, 0)); ?></div>
                <div class="text-slate-400 text-xs font-mono mt-1">RAISED OF R<?php echo e(number_format($cohort->hard_cap / 100, 0)); ?> GOAL</div>
            </div>
            <div class="text-right">
                <div class="text-2xl font-bold text-amber-400"><?php echo e($cohort->member_count ?? 0); ?>/50</div>
        ...
        <div class="w-full bg-slate-800 rounded-full h-3 mb-3 relative overflow-hidden">
            <div class="bg-gradient-to-r from-amber-500 to-amber-400 h-full rounded-full shadow-[0_0_15px_rgba(245,158,11,0.5)] transition-all duration-1000" style="width: <?php echo e(min($percent, 100)); ?>%"></div>
            <!-- MVC Marker -->
            <div class="absolute top-0 bottom-0 w-0.5 bg-slate-600" style="left: <?php echo e($mvcPercent); ?>%"></div>
        </div>
        
        <div class="flex justify-between text-[10px] text-slate-500 font-mono font-bold">
            <span>0%</span>
            <span class="text-slate-300">MVC THRESHOLD: <?php echo e(number_format($mvcPercent, 0)); ?>%</span>
            <span>100%</span>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2 space-y-8">
                ...
                <div class="p-6">
                    <div class="grid grid-cols-2 md:grid-cols-3 gap-6">
                        <div>
                            ...
                            <div class="font-mono text-lg font-bold text-slate-900">R<?php echo e(number_format($cohort->minimum_viable_capital / 100, 0)); ?></div>
                        </div>
                        <div>
                            <div class="text-[10px] text-slate-400 uppercase font-bold tracking-wider mb-1">Ideal Target</div>
                            <div class="font-mono text-lg font-bold text-slate-900">R<?php echo e(number_format($cohort->ideal_target / 100, 0)); ?></div>
                        </div>
                        <div>
                            <div class="text-[10px] text-slate-400 uppercase font-bold tracking-wider mb-1">Hard Cap</div>
                            <div class="font-mono text-lg font-bold text-slate-900">R<?php echo e(number_format($cohort->hard_cap / 100, 0)); ?></div>
                        </div>
                        <div>
                            <div class="text-[10px] text-slate-400 uppercase font-bold tracking-wider mb-1">Setup Fee</div>
                            <div class="font-mono text-lg font-bold text-slate-900"><?php echo e($cohort->setup_fee_percent ?? 2); ?>%</div>
                        </div>
                        <div>
                            <div class="text-[10px] text-slate-400 uppercase font-bold tracking-wider mb-1">Management Fee</div>
                            <div class="font-mono text-lg font-bold text-slate-900"><?php echo e($cohort->management_fee_percent ?? 1); ?>%</div>
                        </div>
                        <div>
                            <div class="text-[10px] text-slate-400 uppercase font-bold tracking-wider mb-1">Performance Fee</div>
                            <div class="font-mono text-lg font-bold text-slate-900"><?php echo e($cohort->performance_fee_percent ?? 10); ?>%</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
                <div class="bg-slate-50/50 p-4 border-b border-slate-100">
                    <h3 class="text-sm font-bold text-slate-900 uppercase tracking-wider flex items-center">
                        ...
                        Gallery <span class="ml-2 text-xs text-slate-400 font-normal">(<?php echo e(count($cohort->images)); ?> images)</span>
                    </h3>
                </div>
                <div class="p-6">
                    <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
                        <?php $__currentLoopData = $cohort->images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $galleryImage): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="group relative aspect-video rounded-xl overflow-hidden bg-slate-100 cursor-pointer hover:shadow-xl transition-all duration-300">
                            <img src="<?php echo e(asset('storage/' . $galleryImage)); ?>" 
                                 alt="<?php echo e($cohort->title); ?> - Image <?php echo e($index + 1); ?>"
                            ...
                            <div class="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                                <div class="absolute bottom-3 left-3 flex items-center space-x-2">
                                    <div class="bg-white/20 backdrop-blur-md px-2 py-1 rounded text-white text-xs font-bold">
                                        <?php echo e($index + 1); ?>/<?php echo e(count($cohort->images)); ?>
                    ...
                    <div class="space-y-4">
                        <div class="flex items-center space-x-4">
                            ...
                            <div class="flex-1">
                                ...
                                <div class="text-xs text-slate-500"><?php echo e($cohort->funding_start_date?->format('d M Y') ?? 'TBD'); ?> - <?php echo e($cohort->funding_end_date?->format('d M Y') ?? 'TBD'); ?></div>
                            </div>
                        </div>
                        <div class="flex items-center space-x-4">
                            ...
                            <div class="flex-1">
                                ...
                                <div class="text-xs text-slate-500"><?php echo e($cohort->expected_deployment_date?->format('d M Y') ?? 'TBD'); ?></div>
                            </div>
                        </div>
                        <div class="flex items-center space-x-4">
                            ...
                            <div class="flex-1">
                                ...
                                <div class="text-xs text-slate-500"><?php echo e($cohort->expected_exit_date?->format('d M Y') ?? 'TBD'); ?></div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-white rounded-2xl border border-slate-200 shadow-xl overflow-hidden">
                ...
                <div class="p-6">
                    ...
                    <div class="h-40 w-full mb-6 relative">
                        ...
                        <div class="absolute top-0 bottom-0 border-l border-dashed border-red-300" style="left: <?php echo e($mvcPercent); ?>%">
                    ...
                    <div class="relative mb-8 pt-6">
                        <input type="range" 
                            id="capital-slider"
                            min="<?php echo e(($cohort->hard_cap ?? 100000) * 0.5); ?>" 
                            max="<?php echo e(($cohort->hard_cap ?? 100000) * 1.1); ?>" 
                            step="5000" 
                            value="<?php echo e($cohort->current_capital ?? 0); ?>"
            ...
            <div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
                ...
                <div class="p-6">
                    <p class="text-sm text-slate-600 leading-relaxed"><?php echo e($cohort->risk_factors); ?></p>
                </div>
            </div>
            <?php endif; ?>
        </div>
                ...
                <div class="bg-white rounded-2xl border border-slate-200 shadow-lg overflow-hidden sticky top-24">
                    <div class="p-6 space-y-4">
                        <div class="flex justify-between items-center text-sm">
                            ...
                            <span class="font-bold text-slate-900">R<?php echo e(number_format(($cohort->hard_cap - $cohort->current_capital) / 100, 0)); ?></span>
                        </div>
                        <div class="flex justify-between items-center text-sm">
                            <span class="text-slate-500">Min Contribution:</span>
                            <span class="font-bold text-slate-900">R<?php echo e(number_format($cohort->min_contribution / 100, 0)); ?></span>
                        </div>
                        ...
                        <?php elseif($canJoin): ?>
                            <a href="<?php echo e(route('cohorts.join', $cohort)); ?>" 
                        ...
                        <?php else: ?>
                            <div class="bg-amber-50 border border-amber-200 rounded-xl p-4 text-center">
                                ...
                                <a href="<?php echo e(route('kyc.form')); ?>" class="inline-block mt-3 text-sm font-bold text-amber-700 hover:text-amber-800">
                                    Complete KYC →
                                </a>
                            </div>
                        <?php endif; ?>
            ...
            <div class="bg-slate-50 p-6 rounded-2xl border border-slate-200 space-y-4">
                ...
                <div class="flex items-start">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-slate-500 mt-1">Capital is locked for <?php echo e($cohort->duration_months ?? 6); ?> months. Secondary market trading available after 30 days.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl border border-slate-200 p-5">
                ...
                <div class="flex items-center space-x-3">
                    <div class="h-10 w-10 rounded-full bg-slate-900 text-amber-400 flex items-center justify-center font-bold text-xs">
                        <?php echo e(strtoupper(substr($cohort->admin->first_name ?? 'A', 0, 1))); ?><?php echo e(strtoupper(substr($cohort->admin->last_name ?? 'D', 0, 1))); ?>

                    </div>
                    <div>
                        <div class="font-bold text-slate-900"><?php echo e($cohort->admin->first_name ?? 'Admin'); ?> <?php echo e($cohort->admin->last_name ?? ''); ?></div>
    ...
    <div class="bg-white rounded-3xl border border-slate-200 shadow-sm overflow-hidden">
        ...
        <div class="divide-y divide-slate-100 max-h-[600px] overflow-y-auto">
            <?php $__empty_1 = true; $__currentLoopData = $cohort->timelines()->latest('event_date')->latest('created_at')->limit(30)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $timeline): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="p-6 hover:bg-slate-50 transition-colors">
                    <div class="flex items-start gap-4">
                        <!-- Event Icon -->
                        <div class="w-12 h-12 <?php echo e($timeline->event_type_color); ?> rounded-xl flex items-center justify-center flex-shrink-0">
                            <i data-lucide="<?php echo e($timeline->event_type_icon); ?>" class="w-6 h-6 text-white"></i>
                        </div>
                        ...
                        <div class="flex-1 min-w-0">
                            <div class="flex items-start justify-between gap-4 mb-2">
                                <div class="flex-1">
                                    <h4 class="font-bold text-slate-900 text-base mb-1"><?php echo e($timeline->title); ?></h4>
                                    <div class="flex items-center gap-2 text-xs text-slate-500">
                                        <i data-lucide="calendar" class="w-3 h-3"></i>
                                        <span><?php echo e($timeline->event_date->format('l, F d, Y')); ?></span>
                                        <?php if($timeline->is_business_day): ?>
                                ...
                                <!-- Event Type Badge -->
                                <span class="text-[10px] font-bold uppercase px-2 py-1 rounded flex-shrink-0 <?php echo e($timeline->event_type === 'profit' ? 'bg-emerald-100 text-emerald-700' : ($timeline->event_type === 'alert' ? 'bg-red-100 text-red-700' : ($timeline->event_type === 'milestone' ? 'bg-amber-100 text-amber-700' : 'bg-slate-100 text-slate-700'))); ?>">
                            ...
                            <!-- Description -->
                            <p class="text-sm text-slate-600 leading-relaxed mb-3"><?php echo e($timeline->description); ?></p>
                            ...
                            <?php if($timeline->profit_amount > 0): ?>
                                <div class="bg-emerald-50 border border-emerald-200 rounded-lg px-3 py-2 inline-flex items-center gap-2 mb-3">
                                    ...
                                    <span class="text-sm font-bold text-emerald-700">
                                        Profit Recorded: R<?php echo e(number_format($timeline->profit_amount / 100, 2)); ?>
                            ...
                            <?php if($timeline->proof_document): ?>
                                <a href="<?php echo e(Storage::url($timeline->proof_document)); ?>" target="_blank" class="inline-flex items-center gap-2 text-xs text-purple-600 hover:text-purple-700 font-bold hover:underline">
                            ...
                            <div class="mt-3 pt-3 border-t border-slate-100 flex items-center gap-2 text-xs text-slate-500">
                                ...
                                <span>Posted by <span class="font-bold text-slate-700"><?php echo e($timeline->user->first_name ?? 'Admin'); ?> <?php echo e($timeline->user->last_name ?? ''); ?></span></span>
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    const simulatorConfig = {
        mvc: <?php echo e($cohort->minimum_viable_capital ?? 0); ?>,
        target: <?php echo e($cohort->hard_cap ?? 100000); ?>,
        currentRaised: <?php echo e($cohort->current_capital ?? 0); ?>
...
<?php echo $__env->make('layouts.modern', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\The round table\The Table\resources\views/cohorts/show-modern.blade.php ENDPATH**/ ?>