...
<?php $__env->startSection('title', 'Create Cohort - RoundTable'); ?>
<?php $__env->startSection('page-title', 'Create Cohort'); ?>
...
<div class="slide-up space-y-6 max-w-4xl mx-auto">
    ...
    <form action="<?php echo e(route('admin.cohorts.store')); ?>" method="POST" enctype="multipart/form-data" class="space-y-6">
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                        placeholder="Describe the investment thesis and goals..."><?php echo e(old('description')); ?></textarea>
                </div>
...
unset($__errorArgs, $__bag); ?>">
                            ...
                            <option value="utilization" <?php echo e(old('cohort_class') == 'utilization' ? 'selected' : ''); ?>>Utilization (Rental Income)</option>
                            <option value="lease" <?php echo e(old('cohort_class') == 'lease' ? 'selected' : ''); ?>>Lease (Asset Leasing)</option>
                            <option value="resale" <?php echo e(old('cohort_class') == 'resale' ? 'selected' : ''); ?>>Resale (Buy & Sell)</option>
                            <option value="hybrid" <?php echo e(old('cohort_class') == 'hybrid' ? 'selected' : ''); ?>>Hybrid (Mixed Strategy)</option>
                        </select>
                    </div>
                    <div>
...
unset($__errorArgs, $__bag); ?>">
                            ...
                            <option value="real_estate" <?php echo e(old('asset_type') == 'real_estate' ? 'selected' : ''); ?>>Real Estate</option>
                            <option value="equipment" <?php echo e(old('asset_type') == 'equipment' ? 'selected' : ''); ?>>Equipment</option>
                            <option value="business" <?php echo e(old('asset_type') == 'business' ? 'selected' : ''); ?>>Business</option>
                            <option value="renewable_energy" <?php echo e(old('asset_type') == 'renewable_energy' ? 'selected' : ''); ?>>Renewable Energy</option>
                            <option value="intellectual_property" <?php echo e(old('asset_type') == 'intellectual_property' ? 'selected' : ''); ?>>Intellectual Property</option>
                            <option value="other" <?php echo e(old('asset_type') == 'other' ? 'selected' : ''); ?>>Other</option>
                        </select>
                    </div>
                </div>
            </div>
            ...
            <div class="p-6 space-y-4">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                        ...
                        <input type="number" name="minimum_viable_capital" value="<?php echo e(old('minimum_viable_capital', 300000)); ?>" min="300000" required
...
unset($__errorArgs, $__bag); ?>"
                    ...
                    <div>
                        ...
                        <input type="number" name="ideal_target" value="<?php echo e(old('ideal_target', 1000000)); ?>" min="300000" required
...
unset($__errorArgs, $__bag); ?>"
                    ...
                    <div>
                        ...
                        <input type="number" name="hard_cap" value="<?php echo e(old('hard_cap', 2000000)); ?>" min="300000" required
...
unset($__errorArgs, $__bag); ?>"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="number" name="min_contribution" value="<?php echo e(old('min_contribution', 300000)); ?>" min="300000" max="10000000" required
...
unset($__errorArgs, $__bag); ?>"
                    ...
                    <div>
                        ...
                        <input type="number" name="max_contribution" value="<?php echo e(old('max_contribution', 10000000)); ?>" min="300000" max="10000000" required
            ...
            <div class="p-6 space-y-4">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="date" name="funding_start_date" value="<?php echo e(old('funding_start_date')); ?>" required
...
unset($__errorArgs, $__bag); ?>">
                    ...
                    <div>
                        ...
                        <input type="date" name="funding_end_date" value="<?php echo e(old('funding_end_date')); ?>" required
...
unset($__errorArgs, $__bag); ?>">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="date" name="expected_exit_date" value="<?php echo e(old('expected_exit_date')); ?>" required
...
unset($__errorArgs, $__bag); ?>">
                    ...
                    <div>
                        ...
                        <input type="number" name="duration_months" value="<?php echo e(old('duration_months', 12)); ?>" min="1" max="120" required
...
unset($__errorArgs, $__bag); ?>">
                            ...
                            <option value="low" <?php echo e(old('risk_level') == 'low' ? 'selected' : ''); ?>>Low Risk</option>
                            <option value="moderate" <?php echo e(old('risk_level') == 'moderate' ? 'selected' : ''); ?>>Moderate Risk</option>
                            <option value="high" <?php echo e(old('risk_level') == 'high' ? 'selected' : ''); ?>>High Risk</option>
                        </select>
                    </div>
                    <div>
                        <label class="block text-sm font-bold text-slate-700 mb-2">Duration (Months) <span class="text-red-500">*</span></label>
                        <input type="number" name="duration_months" id="duration_months" value="<?php echo e(old('duration_months', 12)); ?>" min="1" max="120" required
                            class="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-amber-500 <?php $__errorArgs = ['duration_months'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="number" name="expected_total_payout" id="expected_total_payout" value="<?php echo e(old('expected_total_payout')); ?>" min="0" step="0.01"
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input type="number" name="projected_annual_return" id="projected_annual_return" value="<?php echo e(old('projected_annual_return')); ?>" min="0" max="1000" step="0.01" readonly
...
unset($__errorArgs, $__bag); ?>"
                        placeholder="Describe how investors will exit and receive returns..."><?php echo e(old('exit_strategy')); ?></textarea>
                </div>
                <div>
                    ...
                    <textarea name="risk_factors" rows="2"
                        ...
                        placeholder="Describe potential risks..."><?php echo e(old('risk_factors')); ?></textarea>
                </div>
            </div>
        </div>
        ...
        <div class="flex gap-4 justify-end">
            <a href="<?php echo e(route('admin.cohorts.index')); ?>" class="px-6 py-3 bg-slate-100 text-slate-700 font-bold rounded-xl hover:bg-slate-200 transition">
                Cancel
            </a>
...
<?php echo $__env->make('layouts.modern', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\The round table\The Table\resources\views/admin/cohorts/create.blade.php ENDPATH**/ ?>