...
<?php $__env->startSection('title', 'Join ' . $cohort->title . ' - RoundTable'); ?>
<?php $__env->startSection('page-title', 'Join Project Partnership'); ?>

<?php $__env->startSection('content'); ?>
<div class="slide-up max-w-4xl mx-auto">
    <!-- Back Button -->
    <div class="mb-6">
        <a href="<?php echo e(route('cohorts.show', $cohort)); ?>" class="inline-flex items-center gap-2 px-4 py-2 bg-slate-900/5 hover:bg-slate-900/10 text-slate-700 rounded-xl transition-all border border-slate-200 hover:border-slate-300">
            <i data-lucide="arrow-left" class="w-4 h-4"></i>
            <span class="text-sm font-semibold">Back to <?php echo e($cohort->title); ?></span>
        </a>
    </div>
                ...
                <div class="relative z-10 p-8">
                    ...
                    <div class="relative z-10">
                        <div class="flex flex-wrap items-center gap-2 mb-4">
                            ...
                            ?>
                            <span class="px-3 py-1.5 <?php echo e($riskColors); ?> text-xs font-bold rounded-lg border backdrop-blur-sm">
                        ...
                        <p class="text-slate-200 text-lg drop-shadow"><?php echo e($cohort->title); ?></p>
                        <div class="mt-6 flex items-center gap-4">
                            <div class="flex items-center gap-2 text-white/80">
                                <i data-lucide="trending-up" class="w-4 h-4 text-emerald-400"></i>
                                <span class="text-sm font-semibold"><?php echo e($cohort->projected_annual_return ?? '12-18'); ?>% Projected Return</span>
                            </div>
                            <div class="flex items-center gap-2 text-white/80">
                                <i data-lucide="users" class="w-4 h-4 text-blue-400"></i>
                                <span class="text-sm font-semibold"><?php echo e($cohort->member_count ?? 0); ?>/50 Partners</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="p-6">
                    <?php if(!in_array(Auth::user()->kyc_status, ['approved', 'verified'])): ?>
                        ...
                        <div class="bg-amber-50 border border-amber-200 rounded-xl p-6 text-center">
                            ...
                            <a href="<?php echo e(route('kyc.form')); ?>" class="inline-flex items-center space-x-2 px-6 py-3 bg-amber-600 text-white rounded-xl font-bold hover:bg-amber-700 transition-colors">
                    ...
                    <?php else: ?>
                        <!-- Payment Form -->
                        <form action="<?php echo e(route('cohorts.process-payment', $cohort)); ?>" method="POST" id="paymentForm" class="space-y-6">
                            <?php echo csrf_field(); ?>
                                ...
                                <div class="bg-gradient-to-br from-indigo-50 to-purple-50 border-2 border-indigo-200 rounded-xl p-5">
                                    ...
                                    <div class="mb-4">
                                        <div class="relative">
                                            ...
                                            <input type="number" 
                                                   ...
                                                   value="<?php echo e($cohort->min_contribution / 100); ?>"
                                                   min="<?php echo e($cohort->min_contribution / 100); ?>"
                                                   max="<?php echo e(min($cohort->max_contribution, $cohort->hard_cap - $cohort->current_capital, $walletBalance) / 100); ?>"
                                                   step="100"
                                    ...
                                    <div class="grid grid-cols-3 gap-3 mb-3">
                                        <div class="bg-white/70 rounded-lg p-3 text-center">
                                            ...
                                            <div class="text-sm font-mono font-bold text-slate-900">R<?php echo e(number_format($cohort->min_contribution / 100, 0)); ?></div>
                                        </div>
                                        <div class="bg-white/70 rounded-lg p-3 text-center">
                                            <div class="text-xs text-indigo-600 font-bold mb-1">Your Wallet</div>
                                            <div class="text-sm font-mono font-bold text-slate-900">R<?php echo e(number_format($walletBalance / 100, 0)); ?></div>
                                        </div>
                                        <div class="bg-white/70 rounded-lg p-3 text-center">
                                            <div class="text-xs text-indigo-600 font-bold mb-1">Max Available</div>
                                            <div class="text-sm font-mono font-bold text-slate-900">R<?php echo e(number_format(($cohort->hard_cap - $cohort->current_capital) / 100, 0)); ?></div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="flex items-center justify-between">
                                            ...
                                            <div class="text-right">
                                                <div class="text-2xl font-bold text-indigo-900" id="partnershipPercentage">
                                                    <?php echo e(number_format(($cohort->min_contribution / ($cohort->current_capital + $cohort->min_contribution)) * 100, 2)); ?>%
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div>
                                ...
                                <label class="relative cursor-pointer mb-3 block">
                                    <input type="radio" name="payment_source" value="wallet" class="peer sr-only" <?php echo e($hasEnoughBalance ? 'checked' : ''); ?> id="walletPayment">
                                    <div class="p-5 rounded-xl border-2 border-slate-200 bg-white peer-checked:border-emerald-500 peer-checked:bg-emerald-50/50 transition-all hover:border-slate-300 <?php echo e(!$hasEnoughBalance ? 'opacity-50' : ''); ?>">
                                        <div class="flex items-center justify-between">
                                            <div class="flex items-center space-x-4">
                                                ...
                                                <div>
                                                    ...
                                                    <div class="text-xs text-slate-500">
                                                        Available: R<?php echo e(number_format($walletBalance / 100, 2)); ?>
                                ...
                                <?php if(!$hasEnoughBalance): ?>
                                    <div class="mb-3 p-3 bg-amber-50 border border-amber-200 rounded-lg">
                                        <p class="text-xs text-amber-700">
                                            ...
                                            Need to <a href="<?php echo e(route('wallet.index')); ?>" class="font-bold text-amber-800 hover:text-amber-900 underline">add funds to your wallet</a>? You need at least R<?php echo e(number_format($cohort->min_contribution / 100, 2)); ?> to join this cohort.
                                        </p>
                                    </div>
                                <?php endif; ?>
                                ...
                                <label class="relative cursor-pointer block">
                                    <input type="radio" name="payment_source" value="direct" class="peer sr-only" <?php echo e(!$hasEnoughBalance ? 'checked' : ''); ?> id="cryptoPayment">
            ...
            <div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden sticky top-24">
                ...
                <div class="p-5 space-y-4">
                    <div class="flex justify-between items-center">
                        ...
                        <span class="text-sm font-bold text-slate-900"><?php echo e($cohort->title); ?></span>
                    </div>
                    <div class="flex justify-between items-center">
                        <span class="text-sm text-slate-500">Type</span>
                        <span class="text-sm font-bold text-slate-900"><?php echo e(ucfirst($cohort->cohort_class ?? 'Standard')); ?></span>
                    </div>
                    <div class="flex justify-between items-center">
                        <span class="text-sm text-slate-500">Duration</span>
                        <span class="text-sm font-bold text-slate-900"><?php echo e($cohort->duration_months ?? 6); ?> Months</span>
                    </div>
                    <div class="flex justify-between items-center">
                        <span class="text-sm text-slate-500">Target Return</span>
                        <span class="text-sm font-bold text-emerald-600"><?php echo e($cohort->projected_annual_return ?? '12-18'); ?>%</span>
                    </div>
                    <div class="flex justify-between items-center">
                        <span class="text-sm text-slate-500">Partners</span>
                        <span class="text-sm font-bold text-slate-900"><?php echo e($cohort->member_count ?? 0); ?>/50</span>
                    </div>
                    ...
                    <div class="pt-4 border-t border-slate-100">
                        ...
                        <div class="flex justify-between text-xs mb-2">
                            ...
                            <span class="font-bold text-slate-900"><?php echo e(number_format($percent, 0)); ?>%</span>
                        </div>
                        <div class="w-full bg-slate-100 rounded-full h-2 overflow-hidden">
                            <div class="bg-gradient-to-r from-indigo-600 to-purple-600 h-full rounded-full transition-all" style="width: <?php echo e(min($percent, 100)); ?>%"></div>
                        </div>
                    </div>
...
<script>
    ...
    const currentCapital = <?php echo e($cohort->current_capital); ?>;
    
    // Sync slider with input
    contributionAmount?.addEventListener('input', function() {
        const value = parseFloat(this.value) || <?php echo e($cohort->min_contribution / 100); ?>;
    ...
    document.getElementById('paymentForm')?.addEventListener('submit', function(e) {
        ...
        const minContribution = <?php echo e($cohort->min_contribution / 100); ?>;
        const maxContribution = <?php echo e(min($cohort->max_contribution, $cohort->hard_cap - $cohort->current_capital) / 100); ?>;
...
<?php echo $__env->make('layouts.modern', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\The round table\The Table\resources\views/cohorts/join-usdt.blade.php ENDPATH**/ ?>