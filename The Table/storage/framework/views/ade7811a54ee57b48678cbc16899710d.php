...
<?php $__env->startSection('title', 'Notifications - RoundTable'); ?>
...
<div class="slide-up space-y-8">
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        ...
        <?php if($notifications->where('read', false)->count() > 0): ?>
            <form action="<?php echo e(route('member.notifications.mark-all-read')); ?>" method="POST" class="inline">
                <?php echo csrf_field(); ?>
    ...
    <div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
        <?php $__empty_1 = true; $__currentLoopData = $notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="p-5 border-b border-slate-100 <?php echo e(!$notification->read ? 'bg-amber-50/30' : ''); ?> hover:bg-slate-50 transition-colors group">
                <div class="flex items-start space-x-4">
                    ...
                    <div class="flex-shrink-0">
                        ...
                        ?>
                        <div class="w-10 h-10 rounded-xl <?php echo e($iconClass); ?> flex items-center justify-center">
                            <i data-lucide="<?php echo e($iconName); ?>" class="w-5 h-5"></i>
                        </div>
                    </div>
                    ...
                    <div class="flex-1 min-w-0">
                        <div class="flex items-start justify-between">
                            <div class="flex-1">
                                <p class="font-bold text-slate-900 <?php echo e(!$notification->read ? '' : 'font-medium'); ?>">
                            ...
                            <div class="flex items-center space-x-2 ml-4">
                                <?php if($notification->action_url): ?>
                                    <a href="<?php echo e($notification->action_url); ?>" class="text-amber-600 hover:text-amber-700 transition-colors">
                                        <i data-lucide="external-link" class="w-4 h-4"></i>
                                    </a>
                                <?php endif; ?>
                                <?php if(!$notification->read): ?>
                                    <form action="<?php echo e(route('member.notifications.read', $notification)); ?>" method="POST" class="inline">
                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.modern', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\The round table\The Table\resources\views/member/notifications.blade.php ENDPATH**/ ?>