        ...
        <div class="max-w-7xl mx-auto px-6 py-4">
            <div class="flex justify-between items-center">
                ...
                <div class="hidden md:flex items-center space-x-8">
                    <a href="<?php echo e(route('cohorts.index')); ?>" class="text-sm text-slate-400 hover:text-white transition-colors">Browse Cohorts</a>
                ...
                <div class="flex items-center space-x-3">
                    <?php if(auth()->guard()->check()): ?>
                        <a href="<?php echo e(route('member.dashboard')); ?>" class="px-5 py-2.5 bg-gradient-to-r from-amber-500 to-amber-600 text-white text-sm font-bold rounded-xl hover:from-amber-600 hover:to-amber-700 transition-all shadow-lg shadow-amber-900/20">
                            Dashboard
                        </a>
                    <?php else: ?>
                        <a href="<?php echo e(route('login')); ?>" class="text-sm text-slate-400 hover:text-white transition-colors hidden sm:block">Sign In</a>
                        <a href="<?php echo e(route('register')); ?>" class="px-5 py-2.5 bg-gradient-to-r from-amber-500 to-amber-600 text-white text-sm font-bold rounded-xl hover:from-amber-600 hover:to-amber-700 transition-all shadow-lg shadow-amber-900/20">
                            Get Started
                        </a>
                    <?php endif; ?>
                </div>
            ...
            <div class="grid lg:grid-cols-2 gap-12 items-center">
                ...
                <div class="text-center lg:text-left">
                    ...
                    <div class="flex flex-col sm:flex-row items-center lg:items-start justify-center lg:justify-start space-y-4 sm:space-y-0 sm:space-x-4 mb-12">
                        <a href="<?php echo e(route('register')); ?>" class="w-full sm:w-auto px-8 py-4 bg-gradient-to-r from-amber-500 to-amber-600 text-white font-bold rounded-xl text-lg hover:from-amber-600 hover:to-amber-700 transition-all shadow-xl shadow-amber-900/30 flex items-center justify-center space-x-2 group pulse-glow">
                            <span>Join as a Partner</span>
                            <i data-lucide="arrow-right" class="w-5 h-5 group-hover:translate-x-1 transition-transform"></i>
                        </a>
                        <a href="<?php echo e(route('cohorts.index')); ?>" class="w-full sm:w-auto px-8 py-4 bg-slate-800/80 backdrop-blur text-white font-bold rounded-xl text-lg hover:bg-slate-700 transition-all border border-slate-700 flex items-center justify-center space-x-2">
            ...
            <div class="bg-gradient-to-br from-slate-800 to-slate-900 border border-slate-700 rounded-3xl p-12 text-center relative overflow-hidden image-card">
                ...
                <div class="relative z-10">
                    ...
                    <div class="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-4">
                        <a href="<?php echo e(route('register')); ?>" class="px-8 py-4 bg-gradient-to-r from-amber-500 to-amber-600 text-white font-bold rounded-xl text-lg hover:from-amber-600 hover:to-amber-700 transition-all shadow-xl shadow-amber-900/30 flex items-center space-x-2 pulse-glow">
    ...
    <footer class="py-12 px-6 border-t border-slate-800 relative z-20">
        <div class="max-w-6xl mx-auto">
            ...
            <div class="mt-8 pt-8 border-t border-slate-800 text-center">
                <p class="text-xs text-slate-500">© <?php echo e(date('Y')); ?> RoundTable. All rights reserved. RoundTable is an algorithmic funding protocol. Capital is deployed at your own risk.</p>
            </div>
        </div>
    </footer>
...
<?php /**PATH C:\wamp64\www\The round table\The Table\resources\views/welcome-modern.blade.php ENDPATH**/ ?>