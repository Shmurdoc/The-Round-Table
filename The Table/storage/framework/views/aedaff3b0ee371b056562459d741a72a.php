...
<section class="mb-10">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div class="group relative bg-gradient-to-br from-slate-800/80 to-slate-900/80 backdrop-blur-xl rounded-2xl border border-slate-700/50 p-5 hover:border-amber-500/30 transition-all duration-300">
            ...
            <div class="text-3xl font-bold text-white mb-1"><?php echo e(number_format($totalMembers ?? 0)); ?></div>
        ...
        <div class="group relative bg-gradient-to-br from-slate-800/80 to-slate-900/80 backdrop-blur-xl rounded-2xl border border-slate-700/50 p-5 hover:border-amber-500/30 transition-all duration-300">
            ...
            <div class="text-3xl font-bold text-white mb-1">R<?php echo e(number_format(($totalInvested ?? 0) / 100, 0)); ?></div>
        ...
        <div class="group relative bg-gradient-to-br from-slate-800/80 to-slate-900/80 backdrop-blur-xl rounded-2xl border border-slate-700/50 p-5 hover:border-amber-500/30 transition-all duration-300">
            ...
            <div class="text-3xl font-bold text-white mb-1"><?php echo e(isset($cohorts) ? $cohorts->count() : ($activeCohorts ?? 0)); ?></div>
        ...
        <div class="group relative bg-gradient-to-br from-slate-800/80 to-slate-900/80 backdrop-blur-xl rounded-2xl border border-slate-700/50 p-5 hover:border-amber-500/30 transition-all duration-300">
            ...
            <div class="text-3xl font-bold text-white mb-1"><?php echo e($pendingKyc ?? 0); ?></div>
            <?php if(($pendingKyc ?? 0) > 0): ?>
                <a href="<?php echo e(route('admin.kyc')); ?>" class="text-xs text-amber-400 hover:text-amber-300 flex items-center gap-1">
    ...
    <div class="lg:col-span-2 space-y-6">
        ...
        <div class="bg-gradient-to-br from-slate-800/80 to-slate-900/80 backdrop-blur-xl rounded-2xl border border-slate-700/50 overflow-hidden">
            <div class="p-5 border-b border-slate-700/50 flex items-center justify-between">
                ...
                <a href="<?php echo e(route('admin.cohorts.create')); ?>" class="px-3 py-1.5 text-xs font-medium text-white bg-amber-500/20 border border-amber-500/30 rounded-lg hover:bg-amber-500/30 transition-colors">
                    <i data-lucide="plus" class="w-3 h-3 inline mr-1"></i>
                    New Cohort
                </a>
            </div>
            <div class="divide-y divide-slate-700/50">
                <?php $__empty_1 = true; $__currentLoopData = $myCohorts ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cohort): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap-3">
                                <div class="w-10 h-10 rounded-xl bg-gradient-to-br from-slate-700 to-slate-800 flex items-center justify-center">
                                    <span class="text-lg font-bold text-amber-400"><?php echo e(substr($cohort->name, 0, 1)); ?></span>
                                </div>
                                <div>
                                    <a href="<?php echo e(route('admin.cohorts.show', $cohort)); ?>" class="font-medium text-white hover:text-amber-400 transition-colors">
                                        <?php echo e($cohort->name); ?>

                                    </a>
                                    <p class="text-xs text-slate-400"><?php echo e($cohort->members_count ?? 0); ?>/<?php echo e($cohort->max_members); ?> members</p>
                                </div>
                            </div>
                            <div class="flex items-center gap-3">
                                <?php
                                ...
                                ?>
                                <span class="px-2 py-0.5 text-xs font-medium rounded-full <?php echo e($statusColors[$cohort->status] ?? 'bg-slate-500/20 text-slate-400'); ?>">
                                    <?php echo e(ucfirst($cohort->status)); ?>

                                </span>
                                <span class="text-sm font-mono text-slate-300">R<?php echo e(number_format(($cohort->contribution_amount ?? 0) / 100, 0)); ?></span>
                            </div>
                        </div>
                        <!-- Progress Bar -->
                        <div class="mt-3">
                            ...
                            <div class="w-full h-1.5 bg-slate-700 rounded-full overflow-hidden">
                                <div class="h-full bg-gradient-to-r from-amber-500 to-amber-400 rounded-full transition-all duration-500" style="width: <?php echo e($progress); ?>%"></div>
                            </div>
                        </div>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    <div class="p-8 text-center">
                        ...
                        <a href="<?php echo e(route('admin.cohorts.create')); ?>" class="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-white bg-amber-500/20 border border-amber-500/30 rounded-lg hover:bg-amber-500/30 transition-colors">
                    ...
                    <div class="p-4 hover:bg-slate-700/20 transition-colors">
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap-3">
                                ...
                                ?>
                                <div class="w-8 h-8 rounded-lg <?php echo e($typeInfo['color']); ?> flex items-center justify-center">
                                    <i data-lucide="<?php echo e($typeInfo['icon']); ?>" class="w-4 h-4"></i>
                                </div>
                                <div>
                                    <p class="text-sm font-medium text-white"><?php echo e($transaction->user->name ?? 'Unknown'); ?></p>
                                    <p class="text-xs text-slate-400"><?php echo e(ucfirst($transaction->type)); ?> • <?php echo e($transaction->created_at->diffForHumans()); ?></p>
                                </div>
                            </div>
                            <div class="text-right">
                                <span class="font-mono text-sm <?php echo e($transaction->type === 'contribution' ? 'text-green-400' : 'text-slate-300'); ?>">
                                    <?php echo e($transaction->type === 'contribution' ? '+' : '-'); ?>R<?php echo e(number_format(($transaction->amount ?? 0) / 100, 2)); ?>
    ...
    <div class="space-y-6">
        ...
        <div class="bg-gradient-to-br from-slate-800/80 to-slate-900/80 backdrop-blur-xl rounded-2xl border border-slate-700/50 overflow-hidden">
            ...
            <div class="p-4 space-y-2">
                <a href="<?php echo e(route('admin.cohorts.create')); ?>" class="flex items-center gap-3 p-3 rounded-xl hover:bg-slate-700/30 transition-colors group">
                ...
                <a href="<?php echo e(route('admin.distributions.index')); ?>" class="flex items-center gap-3 p-3 rounded-xl hover:bg-slate-700/30 transition-colors group">
                ...
                <a href="<?php echo e(route('admin.members')); ?>" class="flex items-center gap-3 p-3 rounded-xl hover:bg-slate-700/30 transition-colors group">
                ...
                <a href="<?php echo e(route('admin.kyc')); ?>" class="flex items-center gap-3 p-3 rounded-xl hover:bg-slate-700/30 transition-colors group">
        ...
        <div class="bg-gradient-to-br from-slate-800/80 to-slate-900/80 backdrop-blur-xl rounded-2xl border border-slate-700/50 overflow-hidden">
            <div class="p-5 border-b border-slate-700/50 flex items-center justify-between">
                ...
                <?php if(($pendingKyc ?? 0) > 0): ?>
                    <span class="px-2 py-0.5 text-xs font-medium bg-amber-500/20 text-amber-400 rounded-full"><?php echo e($pendingKyc); ?></span>
                <?php endif; ?>
            </div>
            <div class="divide-y divide-slate-700/50">
                <?php $__empty_1 = true; $__currentLoopData = $pendingKycUsers ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="p-4 hover:bg-slate-700/20 transition-colors">
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap-3">
                                <div class="w-10 h-10 rounded-full bg-gradient-to-br from-slate-600 to-slate-700 flex items-center justify-center">
                                    <span class="text-sm font-medium text-white"><?php echo e(strtoupper(substr($user->name, 0, 2))); ?></span>
                                </div>
                                <div>
                            ...
                            <a href="<?php echo e(route('admin.kyc.review', $user)); ?>" class="px-3 py-1 text-xs font-medium text-amber-400 bg-amber-500/20 rounded-lg hover:bg-amber-500/30 transition-colors">
                                Review
                            </a>
                        </div>
                    </div>
            ...
            <?php if(($pendingKyc ?? 0) > 5): ?>
                <div class="p-4 border-t border-slate-700/50">
                    <a href="<?php echo e(route('admin.kyc')); ?>" class="block text-center text-sm text-amber-400 hover:text-amber-300 transition-colors">
                        View all <?php echo e($pendingKyc); ?> pending →
                    </a>
                </div>
            <?php endif; ?>
        </div>
...
<?php echo $__env->make('layouts.modern', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\The round table\The Table\resources\views/admin/dashboard-modern.blade.php ENDPATH**/ ?>