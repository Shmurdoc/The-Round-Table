...
<?php $__env->startSection('title', 'KYC Verification - RoundTable'); ?>
<?php $__env->startSection('page-title', 'Identity Verification'); ?>
...
<div class="max-w-4xl mx-auto space-y-6 pb-24">
    ...
    <!-- Status Messages -->
    <?php if(Auth::user()->kyc_status === 'pending'): ?>
    ...
    <?php elseif(Auth::user()->kyc_status === 'approved'): ?>
    ...
    <?php elseif(Auth::user()->kyc_status === 'rejected'): ?>
    <div class="glass-card border-red-500/30 rounded-2xl p-6">
        <div class="flex items-start gap-4">
            ...
            <div class="flex-1">
                ...
                <?php if(Auth::user()->kyc_rejection_reason): ?>
                <div class="bg-red-500/10 border border-red-500/20 rounded-lg p-3">
                    <p class="text-red-400 text-sm"><strong>Reason:</strong> <?php echo e(Auth::user()->kyc_rejection_reason); ?></p>
                </div>
                <?php endif; ?>
            </div>
        </div>
    ...
    <form action="<?php echo e(route('kyc.submit')); ?>" method="POST" enctype="multipart/form-data" class="space-y-6">
        <?php echo csrf_field(); ?>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" 
                               name="id_number" 
                               id="id_number"
                               value="<?php echo e(old('id_number', Auth::user()->kyc_id_number)); ?>" 
                               placeholder="0000000000000" 
                               maxlength="13"
                               class="w-full pl-12 pr-4 py-3 bg-slate-800/50 border border-slate-700/50 rounded-xl text-white placeholder-slate-500 focus:border-amber-500/50 focus:ring-2 focus:ring-amber-500/20 transition-all <?php $__errorArgs = ['id_number'];
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="tel" 
                               ...
                               class="w-full pl-12 pr-4 py-3 bg-slate-800/50 border border-slate-700/50 rounded-xl text-white placeholder-slate-500 focus:border-amber-500/50 focus:ring-2 focus:ring-amber-500/20 transition-all <?php $__errorArgs = ['phone'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500/50 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <textarea name="address" 
                              ...
                              class="w-full px-4 py-3 bg-slate-800/50 border border-slate-700/50 rounded-xl text-white placeholder-slate-500 focus:border-amber-500/50 focus:ring-2 focus:ring-amber-500/20 transition-all resize-none <?php $__errorArgs = ['address'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500/50 <?php unset($message);
            ...
            <div class="p-6 space-y-5">
                ...
                <div>
                    ...
                    <div class="grid grid-cols-3 gap-3">
                        <?php $__currentLoopData = ['TRC20', 'BEP20', 'ERC20']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $network): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <label class="cursor-pointer group">
                            <input type="radio" name="crypto_network" value="<?php echo e($network); ?>" class="peer sr-only" 
                                   <?php echo e(old('crypto_network', Auth::user()->crypto_network ?? 'TRC20') == $network ? 'checked' : ''); ?> required>
                            <div class="p-4 border-2 border-slate-700/50 rounded-xl text-center font-medium text-slate-400 peer-checked:border-green-500 peer-checked:bg-green-500/10 peer-checked:text-green-400 transition-all group-hover:border-slate-600">
                                <div class="text-lg mb-1"><?php echo e($network); ?></div>
                                <?php if($network == 'TRC20'): ?>
                    ...
                    <?php $__errorArgs = ['crypto_network'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" 
                               ...
                               value="<?php echo e(old('crypto_wallet_address', Auth::user()->crypto_wallet_address)); ?>" 
                               placeholder="Enter your USDT wallet address"
                               class="w-full pl-12 pr-4 py-3 bg-slate-800/50 border border-slate-700/50 rounded-xl text-white placeholder-slate-500 font-mono text-sm focus:border-green-500/50 focus:ring-2 focus:ring-green-500/20 transition-all <?php $__errorArgs = ['crypto_wallet_address'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500/50 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                    ...
                    <?php $__errorArgs = ['crypto_wallet_address'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" 
                               ...
                               value="<?php echo e(old('account_holder_name', Auth::user()->name)); ?>" 
                               placeholder="Enter your full name"
                               class="w-full pl-12 pr-4 py-3 bg-slate-800/50 border border-slate-700/50 rounded-xl text-white placeholder-slate-500 focus:border-purple-500/50 focus:ring-2 focus:ring-purple-500/20 transition-all <?php $__errorArgs = ['account_holder_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500/50 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="glass-card rounded-2xl border border-green-500/30 p-10 text-center">
        ...
        <a href="<?php echo e(route('cohorts.index')); ?>" class="inline-flex items-center gap-2 py-4 px-8 bg-gradient-to-r from-green-400 to-green-600 hover:from-green-500 hover:to-green-700 text-white font-bold rounded-xl shadow-lg shadow-green-500/30 hover:shadow-green-500/50 transition-all transform hover:scale-[1.02] group">
...
<?php echo $__env->make('layouts.modern', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\The round table\The Table\resources\views/kyc/submit.blade.php ENDPATH**/ ?>